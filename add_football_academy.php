<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO football_academy_list_ctg (academy_name, academy_address, academy_phone, academy_email, registration_fee, monthly_fee, venue, coach, date_of_registration_academy)
        ...
        if (mysqli_query($con, $sql)) {
            echo "<script>alert('Added Football Academy Successful');
                    window.location.href = 'manage_football_academy.php';
                    </script>";
        } else {
...
<head>
    ...
    <title>Add Football Academy</title>
...
<div class="container">
    <div class="form-container">
        <form action="add_football_academy.php" method="POST">
