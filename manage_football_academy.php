...
<head>
    ...
    <title>Manage Football Academy</title>
    ...
    <script>
        function confirmDelete(email) {
            if (confirm("Are you sure you want to delete this Academy?")) {
                window.location.href = 'delete_football_academy.php?academy_email=' + email;
            }
        }
    </script>
</head>
...
<header>
    ...
    <ul>
        ...
        <li><a href="add_football_academy.php" class="btn btn-edit" id="add">Add Academy</a></li>
    </ul>
</header>
<table>
    <tr>
    ...
    ?>
            <tr>
                ...
                <td>
                <button class="btn btn-edit" onclick="window.location.href='edit_football_academy.php?academy_email=<?php echo $row['academy_email']; ?>'">Edit</button>
